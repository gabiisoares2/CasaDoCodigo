...
namespace CasaDoCodigo.Controllers
{
    public class PedidoController : Controller
    {
        ...
        {
            var listProdutos = produtoRepository.GetProdutos("").Result;
            ViewBag.ListCategoria = listProdutos.Produtos.Select(p => p.Categoria).Distinct();
        ...
        {
            var listProdutos = produtoRepository.GetProdutos(pesquisa).Result;
            ViewBag.ListCategoria = listProdutos.Produtos.Select(p => p.Categoria).Distinct();
            return View(listProdutos);
        }
